export default {
  ...
  platform: {
    ...
    geweInboundModeHint: 'Direct callback does not require webhook-router; relay callback/SSE consume webhook-router events',
  ...
  gewe: {
    ...
    commonHint: 'One shared GeWe ingress receives all DM and group messages, then routes by sender wxid to a profile.',
    profileConfig: 'Profile Config',
    profileHint: 'Home channel and proactive delivery settings belong to a specific profile and do not affect shared ingress.',
    sharedEnabledHint: 'Enable the web-ui shared GeWe ingress; callbacks are routed to bound profiles by sender wxid.',
    callbackUrl: 'Callback URL',
    callbackUrlHint: 'Configure this URL in GeWe or webhook-router; web-ui dispatches inbound messages to profiles.',
    inboundHint: 'Web UI callback is recommended; relay modes are for webhook-router forwarding.',
    bindings: 'Bindings',
