export default {
  ...
  platform: {
    ...
    geweTokenHint: 'GeWe API X-GEWE-TOKEN header value; must be unique per profile',
    geweAppId: 'GeWe App ID',
    geweAppIdHint: 'appId used by GeWe callbacks and send APIs; must be unique per profile',
    ...
    geweRelayAppHint: 'Webhook-router App ID/token; must be unique per profile when webhook-router is used',
    ...
    geweGroupPolicyHint: 'Controls group message ingress for the current profile; mention checks match the bot wxid exactly',
  ...
  gewe: {
    title: 'GeWe',
    commonConfig: 'Config',
    commonHint: 'GeWe settings for the current profile.',
    profileConfig: 'Profile Config',
    profileHint: 'Each profile configures and runs its own GeWe channel; incoming messages go directly to that profile.',
    enabledHint: 'Enable the GeWe channel for the current profile.',
    ...
    relaySseAppHint: 'The SSE listener URL is derived from the webhook-router URL, App ID, and token, for example /apps/app-id/events?token=xxxx. App ID and token cannot be reused by another profile.',
    ...
    ingressHint: 'Choose GeWe native callback or webhook-router relay for the current profile only.',
    deliveryConfig: 'Proactive Delivery',
    deliveryHint: 'Scheduled tasks and startup notifications are sent here.',
    accessConfig: 'Access Control',
    accessHint: 'Control which wxids or group messages can enter the current profile.',
    unauthorizedDmPair: 'Send pairing hint',
    unauthorizedDmIgnore: 'Ignore',
    groupPolicyPaired: 'Authorized Users',
