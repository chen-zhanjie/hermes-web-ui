export default {
  ...
  platform: {
    ...
    geweEnabled: 'Enable GeWe',
    geweEnabledHint: 'Enable the native Hermes Agent GeWe WeChat channel',
    geweToken: 'GeWe Token',
    geweTokenHint: 'GeWe API X-GEWE-TOKEN header value',
    geweAppId: 'GeWe App ID',
    geweAppIdHint: 'appId used by GeWe callbacks and send APIs',
    geweBotWxid: 'Bot WeChat wxid',
    geweBotWxidHint: 'Required; group mentions only match the at-user wxid list in GeWe callbacks',
    geweApiBaseUrl: 'GeWe API Base URL',
    geweApiBaseUrlHint: 'Outbound sends and media downloads call GeWe directly',
    geweInboundMode: 'Inbound Mode',
    geweInboundModeHint: 'GeWe Native Callback receives GeWe callbacks directly; Webhook-router Callback/SSE forwards through webhook-router',
    geweCallbackUrl: 'Callback Listener',
    geweCallbackUrlHint: 'Host, port, and path used by direct-callback and relay-callback',
    geweCallbackSecret: 'Callback Secret',
    geweCallbackSecretHint: 'Optional shared secret required in X-Hermes-Gewe-Secret or X-Gewe-Secret',
    geweRelayBaseUrl: 'Webhook-router URL',
    geweRelayBaseUrlHint: 'Used by relay modes; https://hook.yunzxu.com is supported',
    geweRelayApp: 'Webhook-router App',
    geweRelayAppHint: 'relay-sse uses app id/token; channel filters events to one route',
    geweRelaySseUrl: 'SSE URL',
    geweRelaySseUrlHint: 'Optional explicit URL; otherwise built from webhook-router URL and App ID',
    geweAllowedUsers: 'Allowed Users',
    geweAllowedUsersHint: 'Comma-separated wxids allowed to use the Agent; GEWE_ALLOW_ALL_USERS can open access',
    geweAllowAllUsers: 'Allow All Users',
    geweAllowAllUsersHint: 'Skip DM sender allowlist checks; keep this off in production and use pairing codes or allowed users for access control',
    unauthorizedDmBehavior: 'Unauthorized DM Behavior',
    geweUnauthorizedDmBehaviorHint: 'Unauthorized DMs can receive a pairing code automatically or be ignored',
    geweDownloadMedia: 'Download Media',
    geweDownloadMediaHint: 'When enabled, images, voice, and files are downloaded through GeWe API before Agent processing',
    homeChannel: 'Home Channel',
    geweHomeChannelHint: 'wxid or chatroom ID for cron jobs, startup notifications, and proactive delivery',
    geweProfileHomeChannelHint: 'wxid or chatroom ID used by this profile for proactive delivery',
    geweProfileRouterStore: 'Profile Binding Store',
    geweProfileRouterStoreHint: 'Binding-store path read by hermes-agent to route wxids/chatrooms to profiles',
    homeChannelName: 'Home Channel Name',
    geweHomeChannelNameHint: 'Display name used for the home channel in Hermes context',
    geweGroupPolicy: 'Group Policy',
    geweGroupPolicyHint: 'Default allows only paired users in groups; /pair binding only works in DMs',
    geweGroupRequireMention: 'Require Group Mention',
    geweGroupRequireMentionHint: 'When enabled, group messages are handled only when the at-user list contains the bot wxid',
    geweGroupAllowedChats: 'Allowed Group Chats',
    geweGroupAllowedChatsHint: 'Comma-separated chatroom IDs; required when group policy is allowlist',
    // QQ
    qqAppId: 'App ID',
  ...
  gewe: {
    ...
    commonHint: 'Hermes gateway owns the shared GeWe ingress, receives all DM and group messages, then routes by sender wxid to a profile.',
    profileConfig: 'Profile Config',
    profileHint: 'Home channel and proactive delivery settings belong to a specific profile and do not affect the gateway ingress.',
    sharedEnabledHint: 'Enable the Hermes gateway GeWe channel; Web UI only writes configuration and bindings.',
    callbackUrl: 'Gateway Callback URL',
    callbackUrlHint: 'Configure this URL in GeWe or webhook-router; it is served by hermes-agent gateway and does not depend on Web UI.',
    inboundHint: 'GeWe Native Callback sends GeWe callbacks directly to hermes-agent gateway; Webhook-router Callback/SSE forwards through webhook-router to the gateway.',
    inboundModeNativeCallback: 'GeWe Native Callback',
    inboundModeRouterCallback: 'Webhook-router Callback',
    inboundModeRouterSse: 'Webhook-router SSE',
    routingMode: 'Profile Routing Mode',
    routingModeHint: 'Standalone ingress serves this gateway/profile only; shared ingress routes by WeChat identity and group bindings to other profiles.',
    routingStandalone: 'Standalone Ingress',
    routingShared: 'Shared Main Ingress',
    relaySseAppHint: 'The SSE listener URL is derived from the webhook-router URL, App ID, and token, for example /apps/{app}/events?token=xxxx.',
    relayChannel: 'Webhook-router Channel',
    relayChannelHint: 'Optional; in Webhook-router Callback mode, only events from this channel are accepted.',
    bindings: 'Bindings',
    bindingsHint: 'DMs and groups both use fromUser wxid to choose the profile; fromGroup is group context only.',
    invites: 'Invite Codes',
    invitesHint: 'Create a code, then ask the user to send /pair CODE in a DM to bind.',
    ...
    wxid: 'wxid',
    wxidPlaceholder: 'User wxid or chatroom ID',
    profile: 'Profile',
    name: 'Name',
    namePlaceholder: 'Display name (optional)',
    groupPolicyPaired: 'Bound Users',
    groupPolicyAllowlist: 'Allowed Groups',
    groupPolicyOpen: 'Open Groups',
    groupPolicyDisabled: 'Groups Off',
  },
