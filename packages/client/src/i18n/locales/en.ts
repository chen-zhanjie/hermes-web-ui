export default {
  ...
  platform: {
    ...
    geweAllowAllUsersHint: 'Skip DM sender allowlist checks; keep this off in production and use approved users for access control',
    unauthorizedDmBehavior: 'Unauthorized DM Behavior',
    geweUnauthorizedDmBehaviorHint: 'Unauthorized DMs can receive an authorization code automatically or be ignored',
  ...
  gewe: {
    ...
    bindings: 'Bindings',
    bindingsHint: 'This is the profile binding store read by hermes-agent; DMs and groups both use fromUser wxid to choose the profile.',
    discoveredUsers: 'WeChat Identities',
    discoveredUsersHint: 'Loaded from GeWe pairing and existing bindings. Pick a profile, then bind the wxid directly.',
    noPairingUser: 'No paired or pending users',
    bindSelectedUser: 'Bind Selected User',
