export default {
  ...
  platform: {
    ...
    geweAllowAllUsersHint: '跳过私聊发送人白名单校验；生产环境建议关闭并用绑定码或允许用户控制访问',
    unauthorizedDmBehavior: '未授权私聊处理',
    geweUnauthorizedDmBehaviorHint: '未授权私聊可自动回复绑定码，或直接忽略',
  ...
  gewe: {
    ...
    routingMode: 'Profile 路由模式',
    routingModeHint: '独立入口只服务当前 gateway/profile；共享主入口会按微信身份和群绑定分流到其他 profile。',
    routingStandalone: '独立入口',
    routingShared: '共享主入口',
    ...
    bindings: '绑定关系',
    bindingsHint: '私聊和群聊都使用 fromUser wxid 判断 profile；fromGroup 只作为群聊上下文。',
    invites: '绑定码',
    invitesHint: '创建绑定码后，让用户在私聊发送 /pair CODE 完成绑定。',
    createInvite: '创建绑定码',
    inviteCreated: '绑定码已创建',
    inviteCode: '绑定码',
