export default {
  ...
  platform: {
    ...
    geweEnabled: '启用 GeWe',
    geweEnabledHint: '启用 Hermes Agent 原生 GeWe 微信渠道',
    geweToken: 'GeWe Token',
    geweTokenHint: 'GeWe API 请求头 X-GEWE-TOKEN',
    geweAppId: 'GeWe App ID',
    geweAppIdHint: 'GeWe 回调和发送接口使用的 appId',
    geweBotWxid: '机器人微信 wxid',
    geweBotWxidHint: "必填；用于群聊 {'@'} 判断，只匹配 GeWe 回调里的 at wxid 列表",
    geweApiBaseUrl: 'GeWe API 地址',
    geweApiBaseUrlHint: '发送消息、下载媒体等操作直连 GeWe',
    geweInboundMode: '消息入口模式',
    geweInboundModeHint: 'GeWe 原生 Callback 直接接收 GeWe 回调；Webhook-router Callback/SSE 通过 webhook-router 中转',
    geweCallbackUrl: 'Callback 监听',
    geweCallbackUrlHint: 'Host、端口、路径；direct-callback 和 relay-callback 使用',
    geweCallbackSecret: 'Callback Secret',
    geweCallbackSecretHint: '可选共享密钥，回调请求需携带 X-Hermes-Gewe-Secret 或 X-Gewe-Secret',
    geweRelayBaseUrl: 'Webhook-router 地址',
    geweRelayBaseUrlHint: 'relay 模式使用；默认可填 https://hook.yunzxu.com',
    geweRelayApp: 'Webhook-router 应用',
    geweRelayAppHint: 'relay-sse 使用 app id/token，channel 用于只消费指定通道',
    geweRelaySseUrl: 'SSE URL',
    geweRelaySseUrlHint: '可选；留空时使用 Webhook-router 地址和 App ID 自动拼接',
    geweAllowedUsers: '允许用户',
    geweAllowedUsersHint: '允许调用 Agent 的 wxid 列表，逗号分隔；也可用 GEWE_ALLOW_ALL_USERS 放开',
    geweAllowAllUsers: '允许所有用户',
    geweAllowAllUsersHint: '跳过私聊发送人白名单校验；生产环境建议关闭并用授权用户控制访问',
    unauthorizedDmBehavior: '未授权私聊处理',
    geweUnauthorizedDmBehaviorHint: '未授权私聊可自动回复授权码，或直接忽略',
    geweDownloadMedia: '下载媒体',
    geweDownloadMediaHint: '开启后图片、语音、文件会通过 GeWe API 下载并交给 Agent 处理',
    homeChannel: '主页频道',
    geweHomeChannelHint: '用于定时任务、启动通知等主动投递的 wxid 或 chatroom ID',
    geweProfileHomeChannelHint: '当前 profile 主动投递使用的 wxid 或 chatroom ID',
    geweProfileRouterStore: 'Profile 绑定表',
    geweProfileRouterStoreHint: '由 hermes-agent 读取的 GeWe 绑定表路径，用于把 wxid/chatroom 分配到 profile',
    homeChannelName: '主页频道名称',
    geweHomeChannelNameHint: '主页频道在 Hermes 上下文里显示的名称',
    geweGroupPolicy: '群聊策略',
    geweGroupPolicyHint: '默认仅已绑定用户可在群里触发；/pair 绑定只允许私聊完成',
    geweGroupRequireMention: "群聊需要 {'@'}",
    geweGroupRequireMentionHint: '开启后仅当 at 列表包含机器人微信 wxid 时处理群聊消息',
    geweGroupAllowedChats: '允许群聊',
    geweGroupAllowedChatsHint: '群聊 chatroom ID 白名单，逗号分隔；allowlist 模式下必填',
    // QQ
    qqAppId: 'App ID',
  ...
  gewe: {
    title: 'GeWe',
    commonConfig: '通用配置',
    commonHint: 'Hermes gateway 持有同一个 GeWe 入口，接收全部私聊和群聊消息，再按发送人 wxid 分发到 profile。',
    profileConfig: 'Profile 独有配置',
    profileHint: '主页频道等主动投递设置属于具体 profile，不影响 gateway 的共享入口。',
    sharedEnabledHint: '启用 Hermes gateway 的 GeWe 渠道；Web UI 只负责写入配置和绑定关系。',
    callbackUrl: 'Gateway Callback 地址',
    callbackUrlHint: '把这个地址配置到 GeWe 或 webhook-router；该入口由 hermes-agent gateway 提供，不依赖 Web UI。',
    inboundHint: 'GeWe 原生 Callback：GeWe 直接回调到 hermes-agent gateway；Webhook-router Callback/SSE：通过 webhook-router 中转到 gateway。',
    inboundModeNativeCallback: 'GeWe 原生 Callback',
    inboundModeRouterCallback: 'Webhook-router Callback',
    inboundModeRouterSse: 'Webhook-router SSE',
    relaySseAppHint: 'SSE 监听地址会由 Webhook-router 地址、App ID 和 token 自动组成，例如 /apps/{app}/events?token=xxxx。',
    relayChannel: 'Webhook-router 通道',
    relayChannelHint: '可选；Webhook-router Callback 模式下只接收指定 channel 的事件。',
    bindings: '绑定关系',
    bindingsHint: '这里是最终写入 hermes-agent 的 profile 绑定表；私聊和群聊都使用 fromUser wxid 判断 profile。',
    discoveredUsers: '待绑定微信身份',
    discoveredUsersHint: '来自 GeWe 授权流程和已绑定关系；选择目标 profile 后即可把这个 wxid 绑定过去。',
    noPairingUser: '暂无待绑定或已授权用户',
    bindSelectedUser: '绑定所选用户',
    pairingStatus: '状态',
    pairingStatusPending: '待授权',
    pairingStatusApproved: '已授权',
    pairingStatusBound: '已绑定',
    bindToProfile: '绑定到当前 profile',
    bindingType: '类型',
    bindingTypeUser: '用户',
    bindingTypeGroup: '群聊',
    identity: '身份 ID',
    listenAll: '监听全部',
    wxid: 'wxid',
    wxidPlaceholder: '用户 wxid 或 chatroom ID',
    profile: 'Profile',
    name: '名称',
    namePlaceholder: '显示名称（可选）',
    groupPolicyPaired: '已绑定用户',
    groupPolicyAllowlist: '允许群聊',
    groupPolicyOpen: '开放群聊',
    groupPolicyDisabled: '关闭群聊',
  },
